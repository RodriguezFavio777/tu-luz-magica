...
export const CheckoutSchema = z.object({
    user_id: z.string().nullable().optional().transform(val => (val && typeof val === 'string' && val.trim() !== '' ? val : null)),
    ...
    payment_method: z.enum(['mercadopago', 'transfer']).optional().default('transfer')
