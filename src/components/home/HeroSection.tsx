            ...
            <div className="relative z-20 container mx-auto px-6 lg:px-12 max-w-7xl flex flex-col items-center text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/40 bg-primary/10 mb-8 backdrop-blur-sm self-center">
                        <TriquetaLogo size={14} animate className="text-primary" aria-hidden="true" />
                    ...
                    <p className="text-lg md:text-xl text-white/80 font-light leading-relaxed mb-10 max-w-2xl mx-auto font-body text-balance">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Link
                            href="/servicios"
                            aria-label="Reservar sesión de tarot o sanación"
                            className="h-16 px-10 rounded-full bg-primary hover:bg-primary-hover text-white font-bold text-base hover:scale-105 transition-all shadow-[0_0_30px_rgba(244,114,182,0.6)] flex items-center justify-center gap-3 active:scale-95"
                        >
                        ...
                        <Link
                            href="/productos"
                            aria-label="Ver tienda esotérica de productos"
                            className="h-16 px-10 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white font-bold text-base hover:bg-white/20 transition-all flex items-center justify-center gap-3 active:scale-95"
                        >
