                    ...
                    >
                        ...
                        <div className="relative rounded-4xl overflow-hidden border border-white/10 aspect-4/5 shadow-[0_0_30px_rgba(244,114,182,0.6)] hover:shadow-[0_0_50px_rgba(244,114,182,0.8)] transition-shadow duration-500">
                            ...
                            <div className="absolute bottom-8 left-8 right-8 glass-panel p-6 rounded-2xl">
                                <div className="flex items-center gap-1 text-secondary mb-2" aria-hidden="true">
                                    {[1, 2, 3, 4, 5].map(i => <Star key={i} className="w-3 h-3 fill-current" />)}
                                </div>
                                <p className="text-white font-medium italic text-sm leading-relaxed font-body">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-8 border-y border-white/5 py-8">
                            <div>
                                ...
                                <span className="text-white/50 text-[10px] uppercase tracking-widest">Almas conectadas</span>
                            </div>
                            <div>
                                <span className="text-3xl font-bold text-white block">7+</span>
                                <span className="text-white/50 text-[10px] uppercase tracking-widest">Años de experiencia</span>
                            </div>
                        </div>

                        <Link
                            href="/sobre-mi"
                            aria-label="Conoce más sobre el camino espiritual de Camí"
                            className="inline-flex items-center gap-4 text-secondary hover:text-primary font-black uppercase tracking-[0.3em] text-[10px] transition-all group"
                        >
